...
class Config:
    ...
    output_directory = ROOT_DIR + "/../exp"
    speaker2id_path = ROOT_DIR + "/../exp\info/speaker"
    emotion2id_path = ROOT_DIR + "/../exp\info/emotion"
    pitch2id_path = ROOT_DIR + "/../exp\info/pitch"
    energy2id_path = ROOT_DIR + "/../exp\info/energy"
    speed2id_path = ROOT_DIR + "/../exp\info/speed"
    bert_path = 'WangZeJun/simbert-base-chinese'
    token_list_path = ROOT_DIR + "/../exp\info/tokenlist"
